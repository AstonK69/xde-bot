...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        if await src.cogs.commands.moderation.check_enabled(ctx) is True:
            ...
            embed.add_field(name="Sign_up", value="Signs yourself up to the current league", inline=True)
            ...
            if await check(self, ctx, manage_roles=True):
                ...
                embed.add_field(name="League_db_names", value="Shows all the table names in the database", inline=True)
                embed.add_field(name="Nickname", value="Changes the nickname of someone", inline=True)
                ...
                embed.add_field(name="Set_command_status", value="Enables or disables all commands", inline=True)
